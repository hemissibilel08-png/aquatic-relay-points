-- ====================================================
-- BIANCOTTO V2 - Nouveau schéma structuré pour journées sportives
-- ====================================================
...
CREATE TABLE public.attempt (
  ...
  UNIQUE(event_id, centre_id, COALESCE(group_id::text, '—'), activity_id)
);
...
CREATE TABLE public.riddle_answer (
  ...
  UNIQUE(event_id, centre_id, COALESCE(group_id::text, '—'), riddle_id, correct) DEFERRABLE INITIALLY DEFERRED
);
