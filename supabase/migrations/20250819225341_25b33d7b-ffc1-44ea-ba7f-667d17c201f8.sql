-- ====================================================
-- BIANCOTTO V2 - Nettoyage complet et recréation
-- ====================================================

-- Suppression complète de tout l'ancien schéma
...
-- Unicité pour les tentatives non répétables
...
-- Unicité réponses énigmes correctes
