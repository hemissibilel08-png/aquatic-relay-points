-- Recréer les fonctions avec SECURITY DEFINER pour éviter la récursion infinie
-- sans les supprimer d'abord (CREATE OR REPLACE)
...
-- Corriger la politique staff_select_policy qui causait la récursion
...
-- Créer un centre de test et un profil admin
...
-- Créer un événement actif par défaut
